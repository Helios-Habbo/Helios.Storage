...
namespace Helios.Storage.Access
{
    public static class AvatarDao
    {
        ...
        /// </summary>
        public static AvatarData GetAvatarByName(this StorageContext context, string name)
        {
        ...
        /// Get avatar by id
        /// </summary>
        public static AvatarData GetAvatarById(this StorageContext context, int id)
        {
            return context.AvatarData
                .Include(x => x.User)
